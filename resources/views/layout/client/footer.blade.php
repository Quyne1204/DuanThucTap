                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        <div class="tg-footercol">
                            <strong class="tg-logo"><a href="javascript:void(0);"><img
                                        src="{{ asset('assets/images/flogo.png') }}"
                                        alt="image description"></a></strong>
                            <ul class="tg-contactinfo">
                                <li>
                                    <i class="icon-apartment"></i>
                                    <address>Số 2 - đường Trịnh Văn Bô - Nam Từ Liêm - Hà Nội</address>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <span>Serving 7 Days A Week From 7am - 20pm</span>
                                </li>
                                <li>
                                    <i class="icon-envelope"></i>
                                    <span>
                                        <em><a href="mailto:quynvph21897@fpt.edu.vn">quynvph21897@fpt.edu.vn</a></em>
                                        <em><a href="mailto:nvq12042003@gmail.com">nvq12042003@gmail.com</a></em>
                                    </span>
                                </li>
                            </ul>
